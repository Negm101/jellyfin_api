...
part of 'live_stream_response_media_source.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LiveStreamResponseMediaSource extends LiveStreamResponseMediaSource {
  @override
  ...
  factory _$LiveStreamResponseMediaSource(
          [void Function(LiveStreamResponseMediaSourceBuilder)? updates]) =>
      (new LiveStreamResponseMediaSourceBuilder()..update(updates))._build();

  _$LiveStreamResponseMediaSource._(
      {this.protocol,
      this.id,
      this.path,
      this.encoderPath,
  ...
  @override
  LiveStreamResponseMediaSource rebuild(
          void Function(LiveStreamResponseMediaSourceBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LiveStreamResponseMediaSourceBuilder toBuilder() =>
      new LiveStreamResponseMediaSourceBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LiveStreamResponseMediaSource &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, protocol.hashCode), id.hashCode), path.hashCode), encoderPath.hashCode), encoderProtocol.hashCode), type.hashCode), container.hashCode), size.hashCode), name.hashCode), isRemote.hashCode), eTag.hashCode), runTimeTicks.hashCode), readAtNativeFramerate.hashCode), ignoreDts.hashCode), ignoreIndex.hashCode), genPtsInput.hashCode), supportsTranscoding.hashCode), supportsDirectStream.hashCode), supportsDirectPlay.hashCode), isInfiniteStream.hashCode), requiresOpening.hashCode), openToken.hashCode), requiresClosing.hashCode),
                                                                                liveStreamId.hashCode),
                                                                            bufferMs.hashCode),
                                                                        requiresLooping.hashCode),
                                                                    supportsProbing.hashCode),
                                                                videoType.hashCode),
                                                            isoType.hashCode),
                                                        video3DFormat.hashCode),
                                                    mediaStreams.hashCode),
                                                mediaAttachments.hashCode),
                                            formats.hashCode),
                                        bitrate.hashCode),
                                    timestamp.hashCode),
                                requiredHttpHeaders.hashCode),
                            transcodingUrl.hashCode),
                        transcodingSubProtocol.hashCode),
                    transcodingContainer.hashCode),
                analyzeDurationMs.hashCode),
            defaultAudioStreamIndex.hashCode),
        defaultSubtitleStreamIndex.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LiveStreamResponseMediaSource')
...
class LiveStreamResponseMediaSourceBuilder
    implements
        Builder<LiveStreamResponseMediaSource,
            LiveStreamResponseMediaSourceBuilder>,
        MediaSourceInfoBuilder {
  _$LiveStreamResponseMediaSource? _$v;
  ...
  LiveStreamResponseMediaSourceBuilder() {
    LiveStreamResponseMediaSource._defaults(this);
  }

  LiveStreamResponseMediaSourceBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant LiveStreamResponseMediaSource other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$LiveStreamResponseMediaSource;
  }

  @override
  void update(void Function(LiveStreamResponseMediaSourceBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LiveStreamResponseMediaSource build() => _build();

  _$LiveStreamResponseMediaSource _build() {
    _$LiveStreamResponseMediaSource _$result;
    try {
      _$result = _$v ??
          new _$LiveStreamResponseMediaSource._(
              protocol: protocol,
              id: id,
              path: path,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'LiveStreamResponseMediaSource', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
