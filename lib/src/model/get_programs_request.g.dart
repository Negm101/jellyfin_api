...
part of 'get_programs_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GetProgramsRequest extends GetProgramsRequest {
  @override
  ...
  factory _$GetProgramsRequest(
          [void Function(GetProgramsRequestBuilder)? updates]) =>
      (new GetProgramsRequestBuilder()..update(updates))._build();

  _$GetProgramsRequest._(
      {this.channelIds,
      this.userId,
      this.minStartDate,
      this.hasAired,
  ...
  @override
  GetProgramsRequest rebuild(
          void Function(GetProgramsRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetProgramsRequestBuilder toBuilder() =>
      new GetProgramsRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetProgramsRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetProgramsRequest')
...
class GetProgramsRequestBuilder
    implements
        Builder<GetProgramsRequest, GetProgramsRequestBuilder>,
        GetProgramsDtoBuilder {
  _$GetProgramsRequest? _$v;
  ...
  GetProgramsRequestBuilder() {
    GetProgramsRequest._defaults(this);
  }

  GetProgramsRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant GetProgramsRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GetProgramsRequest;
  }

  @override
  void update(void Function(GetProgramsRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GetProgramsRequest build() => _build();

  _$GetProgramsRequest _build() {
    _$GetProgramsRequest _$result;
    try {
      _$result = _$v ??
          new _$GetProgramsRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GetProgramsRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
