...
part of 'person_lookup_info_remote_search_query_search_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PersonLookupInfoRemoteSearchQuerySearchInfo
    extends PersonLookupInfoRemoteSearchQuerySearchInfo {
  @override
  final String? name;
  @override
  ...
  factory _$PersonLookupInfoRemoteSearchQuerySearchInfo(
          [void Function(PersonLookupInfoRemoteSearchQuerySearchInfoBuilder)?
              updates]) =>
      (new PersonLookupInfoRemoteSearchQuerySearchInfoBuilder()
            ..update(updates))
          ._build();

  _$PersonLookupInfoRemoteSearchQuerySearchInfo._(
      {this.name,
      this.originalTitle,
      this.path,
  ...
  @override
  PersonLookupInfoRemoteSearchQuerySearchInfo rebuild(
          void Function(PersonLookupInfoRemoteSearchQuerySearchInfoBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PersonLookupInfoRemoteSearchQuerySearchInfoBuilder toBuilder() =>
      new PersonLookupInfoRemoteSearchQuerySearchInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PersonLookupInfoRemoteSearchQuerySearchInfo &&
        name == other.name &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'PersonLookupInfoRemoteSearchQuerySearchInfo')
          ..add('name', name)
...
class PersonLookupInfoRemoteSearchQuerySearchInfoBuilder
    implements
        Builder<PersonLookupInfoRemoteSearchQuerySearchInfo,
            PersonLookupInfoRemoteSearchQuerySearchInfoBuilder>,
        PersonLookupInfoBuilder {
  _$PersonLookupInfoRemoteSearchQuerySearchInfo? _$v;
  ...
  PersonLookupInfoRemoteSearchQuerySearchInfoBuilder() {
    PersonLookupInfoRemoteSearchQuerySearchInfo._defaults(this);
  }

  PersonLookupInfoRemoteSearchQuerySearchInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant PersonLookupInfoRemoteSearchQuerySearchInfo other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PersonLookupInfoRemoteSearchQuerySearchInfo;
  }
  ...
  @override
  PersonLookupInfoRemoteSearchQuerySearchInfo build() => _build();

  _$PersonLookupInfoRemoteSearchQuerySearchInfo _build() {
    _$PersonLookupInfoRemoteSearchQuerySearchInfo _$result;
    try {
      _$result = _$v ??
          new _$PersonLookupInfoRemoteSearchQuerySearchInfo._(
              name: name,
