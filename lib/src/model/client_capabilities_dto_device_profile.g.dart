...
part of 'client_capabilities_dto_device_profile.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClientCapabilitiesDtoDeviceProfile
    extends ClientCapabilitiesDtoDeviceProfile {
  @override
  final String? name;
  @override
  final String? id;
  ...
  factory _$ClientCapabilitiesDtoDeviceProfile(
          [void Function(ClientCapabilitiesDtoDeviceProfileBuilder)?
              updates]) =>
      (new ClientCapabilitiesDtoDeviceProfileBuilder()..update(updates))
          ._build();

  _$ClientCapabilitiesDtoDeviceProfile._(
      {this.name,
      this.id,
      this.identification,
      this.friendlyName,
  ...
  @override
  ClientCapabilitiesDtoDeviceProfile rebuild(
          void Function(ClientCapabilitiesDtoDeviceProfileBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClientCapabilitiesDtoDeviceProfileBuilder toBuilder() =>
      new ClientCapabilitiesDtoDeviceProfileBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClientCapabilitiesDtoDeviceProfile &&
        name == other.name &&
        id == other.id &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, name.hashCode), id.hashCode), identification.hashCode), friendlyName.hashCode), manufacturer.hashCode), manufacturerUrl.hashCode), modelName.hashCode), modelDescription.hashCode), modelNumber.hashCode), modelUrl.hashCode), serialNumber.hashCode), enableAlbumArtInDidl.hashCode), enableSingleAlbumArtLimit.hashCode), enableSingleSubtitleLimit.hashCode), supportedMediaTypes.hashCode), userId.hashCode), albumArtPn.hashCode), maxAlbumArtWidth.hashCode), maxAlbumArtHeight.hashCode), maxIconWidth.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ClientCapabilitiesDtoDeviceProfile')
          ..add('name', name)
          ..add('id', id)
...
class ClientCapabilitiesDtoDeviceProfileBuilder
    implements
        Builder<ClientCapabilitiesDtoDeviceProfile,
            ClientCapabilitiesDtoDeviceProfileBuilder>,
        DeviceProfileBuilder {
  _$ClientCapabilitiesDtoDeviceProfile? _$v;
  ...
  ClientCapabilitiesDtoDeviceProfileBuilder() {
    ClientCapabilitiesDtoDeviceProfile._defaults(this);
  }

  ClientCapabilitiesDtoDeviceProfileBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
      _id = $v.id;
  ...
  @override
  void replace(covariant ClientCapabilitiesDtoDeviceProfile other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClientCapabilitiesDtoDeviceProfile;
  }
  ...
  @override
  ClientCapabilitiesDtoDeviceProfile build() => _build();

  _$ClientCapabilitiesDtoDeviceProfile _build() {
    _$ClientCapabilitiesDtoDeviceProfile _$result;
    try {
      _$result = _$v ??
          new _$ClientCapabilitiesDtoDeviceProfile._(
              name: name,
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ClientCapabilitiesDtoDeviceProfile', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
