...
abstract class DeviceProfileBuilder {
  ...
  set identification(DeviceProfileIdentificationBuilder? identification);
  ...
  set albumArtPn(String? albumArtPn);
  ...
  set maxIconWidth(int? maxIconWidth);
  ...
  set sonyAggregationFlags(String? sonyAggregationFlags);

  String? get protocolInfo;
  set protocolInfo(String? protocolInfo);
  ...
  set enableMSMediaReceiverRegistrar(bool? enableMSMediaReceiverRegistrar);

  bool? get ignoreTranscodeByteRangeRequests;
  set ignoreTranscodeByteRangeRequests(bool? ignoreTranscodeByteRangeRequests);

  ListBuilder<XmlAttribute> get xmlRootAttributes;
  set xmlRootAttributes(ListBuilder<XmlAttribute>? xmlRootAttributes);
