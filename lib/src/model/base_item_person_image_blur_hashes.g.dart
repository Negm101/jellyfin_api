...
part of 'base_item_person_image_blur_hashes.dart';
...
class _$BaseItemPersonImageBlurHashes extends BaseItemPersonImageBlurHashes {
  ...
  factory _$BaseItemPersonImageBlurHashes(
      ...
      (new BaseItemPersonImageBlurHashesBuilder()..update(updates))._build();

  _$BaseItemPersonImageBlurHashes._(
      {this.primary,
      this.art,
      this.backdrop,
      this.banner,
  ...
  @override
  BaseItemPersonImageBlurHashes rebuild(
          void Function(BaseItemPersonImageBlurHashesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BaseItemPersonImageBlurHashesBuilder toBuilder() =>
      new BaseItemPersonImageBlurHashesBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BaseItemPersonImageBlurHashes &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BaseItemPersonImageBlurHashes')
          ..add('primary', primary)
          ..add('art', art)
...
class BaseItemPersonImageBlurHashesBuilder
    implements
        Builder<BaseItemPersonImageBlurHashes,
  ...
  @override
  void replace(BaseItemPersonImageBlurHashes other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BaseItemPersonImageBlurHashes;
  }

  @override
  void update(void Function(BaseItemPersonImageBlurHashesBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BaseItemPersonImageBlurHashes build() => _build();

  _$BaseItemPersonImageBlurHashes _build() {
    _$BaseItemPersonImageBlurHashes _$result;
    try {
      _$result = _$v ??
          new _$BaseItemPersonImageBlurHashes._(
      ...
      try {
        ...
        _chapter?.build();
        _$failedField = 'boxRear';
        _boxRear?.build();
        _$failedField = 'profile';
        _profile?.build();
      } catch (e) {
        throw new BuiltValueNestedFieldError(
            r'BaseItemPersonImageBlurHashes', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
