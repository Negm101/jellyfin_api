...
part of 'series_info_remote_search_query_search_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SeriesInfoRemoteSearchQuerySearchInfo
    extends SeriesInfoRemoteSearchQuerySearchInfo {
  @override
  final String? name;
  @override
  ...
  factory _$SeriesInfoRemoteSearchQuerySearchInfo(
          [void Function(SeriesInfoRemoteSearchQuerySearchInfoBuilder)?
              updates]) =>
      (new SeriesInfoRemoteSearchQuerySearchInfoBuilder()..update(updates))
          ._build();

  _$SeriesInfoRemoteSearchQuerySearchInfo._(
      {this.name,
      this.originalTitle,
      this.path,
  ...
  @override
  SeriesInfoRemoteSearchQuerySearchInfo rebuild(
          void Function(SeriesInfoRemoteSearchQuerySearchInfoBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SeriesInfoRemoteSearchQuerySearchInfoBuilder toBuilder() =>
      new SeriesInfoRemoteSearchQuerySearchInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SeriesInfoRemoteSearchQuerySearchInfo &&
        name == other.name &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'SeriesInfoRemoteSearchQuerySearchInfo')
          ..add('name', name)
...
class SeriesInfoRemoteSearchQuerySearchInfoBuilder
    implements
        Builder<SeriesInfoRemoteSearchQuerySearchInfo,
            SeriesInfoRemoteSearchQuerySearchInfoBuilder>,
        SeriesInfoBuilder {
  _$SeriesInfoRemoteSearchQuerySearchInfo? _$v;
  ...
  SeriesInfoRemoteSearchQuerySearchInfoBuilder() {
    SeriesInfoRemoteSearchQuerySearchInfo._defaults(this);
  }

  SeriesInfoRemoteSearchQuerySearchInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant SeriesInfoRemoteSearchQuerySearchInfo other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SeriesInfoRemoteSearchQuerySearchInfo;
  }

  @override
  void update(
      void Function(SeriesInfoRemoteSearchQuerySearchInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SeriesInfoRemoteSearchQuerySearchInfo build() => _build();

  _$SeriesInfoRemoteSearchQuerySearchInfo _build() {
    _$SeriesInfoRemoteSearchQuerySearchInfo _$result;
    try {
      _$result = _$v ??
          new _$SeriesInfoRemoteSearchQuerySearchInfo._(
              name: name,
