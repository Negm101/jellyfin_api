...
part of 'user_dto_policy.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$UserDtoPolicy extends UserDtoPolicy {
  @override
  ...
  factory _$UserDtoPolicy([void Function(UserDtoPolicyBuilder)? updates]) =>
      (new UserDtoPolicyBuilder()..update(updates))._build();
  ...
  @override
  UserDtoPolicyBuilder toBuilder() => new UserDtoPolicyBuilder()..replace(this);
...
class UserDtoPolicyBuilder
    implements Builder<UserDtoPolicy, UserDtoPolicyBuilder>, UserPolicyBuilder {
  _$UserDtoPolicy? _$v;
  ...
  UserDtoPolicyBuilder() {
    UserDtoPolicy._defaults(this);
  }

  UserDtoPolicyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant UserDtoPolicy other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UserDtoPolicy;
  }

  @override
  void update(void Function(UserDtoPolicyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UserDtoPolicy build() => _build();

  _$UserDtoPolicy _build() {
    _$UserDtoPolicy _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'UserDtoPolicy', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
