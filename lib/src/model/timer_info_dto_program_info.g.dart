...
part of 'timer_info_dto_program_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TimerInfoDtoProgramInfo extends TimerInfoDtoProgramInfo {
  @override
  final String? name;
  @override
  ...
  factory _$TimerInfoDtoProgramInfo(
          [void Function(TimerInfoDtoProgramInfoBuilder)? updates]) =>
      (new TimerInfoDtoProgramInfoBuilder()..update(updates))._build();

  _$TimerInfoDtoProgramInfo._(
      {this.name,
      this.originalTitle,
      this.serverId,
      this.id,
  ...
  @override
  TimerInfoDtoProgramInfo rebuild(
          void Function(TimerInfoDtoProgramInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TimerInfoDtoProgramInfoBuilder toBuilder() =>
      new TimerInfoDtoProgramInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TimerInfoDtoProgramInfo &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TimerInfoDtoProgramInfo')
          ..add('name', name)
...
class TimerInfoDtoProgramInfoBuilder
    implements
        Builder<TimerInfoDtoProgramInfo, TimerInfoDtoProgramInfoBuilder>,
        BaseItemDtoBuilder {
  _$TimerInfoDtoProgramInfo? _$v;
  ...
  TimerInfoDtoProgramInfoBuilder() {
    TimerInfoDtoProgramInfo._defaults(this);
  }

  TimerInfoDtoProgramInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant TimerInfoDtoProgramInfo other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TimerInfoDtoProgramInfo;
  }

  @override
  void update(void Function(TimerInfoDtoProgramInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TimerInfoDtoProgramInfo build() => _build();

  _$TimerInfoDtoProgramInfo _build() {
    _$TimerInfoDtoProgramInfo _$result;
    try {
      _$result = _$v ??
          new _$TimerInfoDtoProgramInfo._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TimerInfoDtoProgramInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
