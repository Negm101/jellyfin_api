...
part of 'playback_progress_info_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PlaybackProgressInfoItem extends PlaybackProgressInfoItem {
  @override
  final String? name;
  @override
  ...
  factory _$PlaybackProgressInfoItem(
          [void Function(PlaybackProgressInfoItemBuilder)? updates]) =>
      (new PlaybackProgressInfoItemBuilder()..update(updates))._build();

  _$PlaybackProgressInfoItem._(
      {this.name,
      this.originalTitle,
      this.serverId,
      this.id,
  ...
  @override
  PlaybackProgressInfoItem rebuild(
          void Function(PlaybackProgressInfoItemBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PlaybackProgressInfoItemBuilder toBuilder() =>
      new PlaybackProgressInfoItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PlaybackProgressInfoItem &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PlaybackProgressInfoItem')
          ..add('name', name)
...
class PlaybackProgressInfoItemBuilder
    implements
        Builder<PlaybackProgressInfoItem, PlaybackProgressInfoItemBuilder>,
        BaseItemDtoBuilder {
  _$PlaybackProgressInfoItem? _$v;
  ...
  PlaybackProgressInfoItemBuilder() {
    PlaybackProgressInfoItem._defaults(this);
  }

  PlaybackProgressInfoItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant PlaybackProgressInfoItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PlaybackProgressInfoItem;
  }

  @override
  void update(void Function(PlaybackProgressInfoItemBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PlaybackProgressInfoItem build() => _build();

  _$PlaybackProgressInfoItem _build() {
    _$PlaybackProgressInfoItem _$result;
    try {
      _$result = _$v ??
          new _$PlaybackProgressInfoItem._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'PlaybackProgressInfoItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
