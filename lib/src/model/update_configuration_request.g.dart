...
class _$UpdateConfigurationRequest extends UpdateConfigurationRequest {
  @override
  ...
  factory _$UpdateConfigurationRequest(
          [void Function(UpdateConfigurationRequestBuilder)? updates]) =>
      (new UpdateConfigurationRequestBuilder()..update(updates))._build();

  _$UpdateConfigurationRequest._(
  ...
  @override
  UpdateConfigurationRequest rebuild(
          void Function(UpdateConfigurationRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UpdateConfigurationRequestBuilder toBuilder() =>
      new UpdateConfigurationRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UpdateConfigurationRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UpdateConfigurationRequest')
...
class UpdateConfigurationRequestBuilder
    implements
        Builder<UpdateConfigurationRequest, UpdateConfigurationRequestBuilder>,
        ServerConfigurationBuilder {
  _$UpdateConfigurationRequest? _$v;
  ...
  UpdateConfigurationRequestBuilder() {
    UpdateConfigurationRequest._defaults(this);
  }

  UpdateConfigurationRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant UpdateConfigurationRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UpdateConfigurationRequest;
  }

  @override
  void update(void Function(UpdateConfigurationRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UpdateConfigurationRequest build() => _build();

  _$UpdateConfigurationRequest _build() {
    _$UpdateConfigurationRequest _$result;
    try {
      _$result = _$v ??
          new _$UpdateConfigurationRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'UpdateConfigurationRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
