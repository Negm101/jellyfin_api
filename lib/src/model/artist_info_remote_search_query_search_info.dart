...
part 'artist_info_remote_search_query_search_info.g.dart';
...
/// * [songInfos] 
@BuiltValue()
abstract class ArtistInfoRemoteSearchQuerySearchInfo implements ArtistInfo, Built<ArtistInfoRemoteSearchQuerySearchInfo, ArtistInfoRemoteSearchQuerySearchInfoBuilder> {
  ArtistInfoRemoteSearchQuerySearchInfo._();

  factory ArtistInfoRemoteSearchQuerySearchInfo([void updates(ArtistInfoRemoteSearchQuerySearchInfoBuilder b)]) = _$ArtistInfoRemoteSearchQuerySearchInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ArtistInfoRemoteSearchQuerySearchInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ArtistInfoRemoteSearchQuerySearchInfo> get serializer => _$ArtistInfoRemoteSearchQuerySearchInfoSerializer();
}

class _$ArtistInfoRemoteSearchQuerySearchInfoSerializer implements PrimitiveSerializer<ArtistInfoRemoteSearchQuerySearchInfo> {
  @override
  final Iterable<Type> types = const [ArtistInfoRemoteSearchQuerySearchInfo, _$ArtistInfoRemoteSearchQuerySearchInfo];

  @override
  final String wireName = r'ArtistInfoRemoteSearchQuerySearchInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ArtistInfoRemoteSearchQuerySearchInfo object, {
  ...
  void _deserializeProperties(
    ...
    required ArtistInfoRemoteSearchQuerySearchInfoBuilder result,
  ...
  @override
  ArtistInfoRemoteSearchQuerySearchInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ArtistInfoRemoteSearchQuerySearchInfoBuilder();
