...
class UpdateItemRequestBuilder
    implements
        Builder<UpdateItemRequest, UpdateItemRequestBuilder>,
        BaseItemDtoBuilder {
  ...
  @override
  void replace(covariant UpdateItemRequest other) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'UpdateItemRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
