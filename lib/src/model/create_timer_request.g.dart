...
part of 'create_timer_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CreateTimerRequest extends CreateTimerRequest {
  @override
  final String? id;
  @override
  final String? type;
  ...
  factory _$CreateTimerRequest(
          [void Function(CreateTimerRequestBuilder)? updates]) =>
      (new CreateTimerRequestBuilder()..update(updates))._build();

  _$CreateTimerRequest._(
      {this.id,
      this.type,
      this.serverId,
      this.externalId,
  ...
  @override
  CreateTimerRequest rebuild(
          void Function(CreateTimerRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateTimerRequestBuilder toBuilder() =>
      new CreateTimerRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreateTimerRequest &&
        id == other.id &&
        type == other.type &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CreateTimerRequest')
          ..add('id', id)
          ..add('type', type)
...
class CreateTimerRequestBuilder
    implements
        Builder<CreateTimerRequest, CreateTimerRequestBuilder>,
        TimerInfoDtoBuilder {
  _$CreateTimerRequest? _$v;
  ...
  CreateTimerRequestBuilder() {
    CreateTimerRequest._defaults(this);
  }

  CreateTimerRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _type = $v.type;
  ...
  @override
  void replace(covariant CreateTimerRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CreateTimerRequest;
  }

  @override
  void update(void Function(CreateTimerRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CreateTimerRequest build() => _build();

  _$CreateTimerRequest _build() {
    _$CreateTimerRequest _$result;
    try {
      _$result = _$v ??
          new _$CreateTimerRequest._(
              id: id,
              type: type,
              serverId: serverId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'CreateTimerRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
