...
part of 'client_capabilities_device_profile.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ClientCapabilitiesDeviceProfile
    extends ClientCapabilitiesDeviceProfile {
  @override
  final String? name;
  @override
  final String? id;
  ...
  factory _$ClientCapabilitiesDeviceProfile(
          [void Function(ClientCapabilitiesDeviceProfileBuilder)? updates]) =>
      (new ClientCapabilitiesDeviceProfileBuilder()..update(updates))._build();

  _$ClientCapabilitiesDeviceProfile._(
      {this.name,
      this.id,
      this.identification,
      this.friendlyName,
  ...
  @override
  ClientCapabilitiesDeviceProfile rebuild(
          void Function(ClientCapabilitiesDeviceProfileBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ClientCapabilitiesDeviceProfileBuilder toBuilder() =>
      new ClientCapabilitiesDeviceProfileBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ClientCapabilitiesDeviceProfile &&
        name == other.name &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ClientCapabilitiesDeviceProfile')
          ..add('name', name)
          ..add('id', id)
...
class ClientCapabilitiesDeviceProfileBuilder
    implements
        Builder<ClientCapabilitiesDeviceProfile,
            ClientCapabilitiesDeviceProfileBuilder>,
        DeviceProfileBuilder {
  _$ClientCapabilitiesDeviceProfile? _$v;
  ...
  ClientCapabilitiesDeviceProfileBuilder() {
    ClientCapabilitiesDeviceProfile._defaults(this);
  }

  ClientCapabilitiesDeviceProfileBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
      _id = $v.id;
  ...
  @override
  void replace(covariant ClientCapabilitiesDeviceProfile other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ClientCapabilitiesDeviceProfile;
  }

  @override
  void update(void Function(ClientCapabilitiesDeviceProfileBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ClientCapabilitiesDeviceProfile build() => _build();

  _$ClientCapabilitiesDeviceProfile _build() {
    _$ClientCapabilitiesDeviceProfile _$result;
    try {
      _$result = _$v ??
          new _$ClientCapabilitiesDeviceProfile._(
              name: name,
              id: id,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ClientCapabilitiesDeviceProfile', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
