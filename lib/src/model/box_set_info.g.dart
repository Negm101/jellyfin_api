...
abstract class BoxSetInfoBuilder {
  void replace(BoxSetInfo other);
  void update(void Function(BoxSetInfoBuilder) updates);
  String? get name;
...
class _$$BoxSetInfo extends $BoxSetInfo {
  @override
  final String? name;
  @override
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$BoxSetInfo')
          ..add('name', name)
...
class $BoxSetInfoBuilder
    implements Builder<$BoxSetInfo, $BoxSetInfoBuilder>, BoxSetInfoBuilder {
  _$$BoxSetInfo? _$v;
  ...
  $BoxSetInfoBuilder() {
    $BoxSetInfo._defaults(this);
  }

  $BoxSetInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant $BoxSetInfo other) {
