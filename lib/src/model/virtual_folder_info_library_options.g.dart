...
part of 'virtual_folder_info_library_options.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$VirtualFolderInfoLibraryOptions
    extends VirtualFolderInfoLibraryOptions {
  @override
  ...
  factory _$VirtualFolderInfoLibraryOptions(
          [void Function(VirtualFolderInfoLibraryOptionsBuilder)? updates]) =>
      (new VirtualFolderInfoLibraryOptionsBuilder()..update(updates))._build();

  _$VirtualFolderInfoLibraryOptions._(
      {this.enablePhotos,
  ...
  @override
  VirtualFolderInfoLibraryOptions rebuild(
          void Function(VirtualFolderInfoLibraryOptionsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VirtualFolderInfoLibraryOptionsBuilder toBuilder() =>
      new VirtualFolderInfoLibraryOptionsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VirtualFolderInfoLibraryOptions &&
                ...
                $jc(
                    $jc(
                        $jc(
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc(0, enablePhotos.hashCode), enableRealtimeMonitor.hashCode), enableChapterImageExtraction.hashCode), extractChapterImagesDuringLibraryScan.hashCode), pathInfos.hashCode), saveLocalMetadata.hashCode), enableInternetProviders.hashCode), enableAutomaticSeriesGrouping.hashCode),
                            ...
                            subtitleDownloadLanguages.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VirtualFolderInfoLibraryOptions')
...
class VirtualFolderInfoLibraryOptionsBuilder
    implements
        Builder<VirtualFolderInfoLibraryOptions,
            VirtualFolderInfoLibraryOptionsBuilder>,
        LibraryOptionsBuilder {
  _$VirtualFolderInfoLibraryOptions? _$v;
  ...
  VirtualFolderInfoLibraryOptionsBuilder() {
    VirtualFolderInfoLibraryOptions._defaults(this);
  }

  VirtualFolderInfoLibraryOptionsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant VirtualFolderInfoLibraryOptions other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VirtualFolderInfoLibraryOptions;
  }

  @override
  void update(void Function(VirtualFolderInfoLibraryOptionsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VirtualFolderInfoLibraryOptions build() => _build();

  _$VirtualFolderInfoLibraryOptions _build() {
    _$VirtualFolderInfoLibraryOptions _$result;
    try {
      _$result = _$v ??
          new _$VirtualFolderInfoLibraryOptions._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VirtualFolderInfoLibraryOptions', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
