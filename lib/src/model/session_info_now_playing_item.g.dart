...
part of 'session_info_now_playing_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SessionInfoNowPlayingItem extends SessionInfoNowPlayingItem {
  @override
  final String? name;
  @override
  ...
  factory _$SessionInfoNowPlayingItem(
          [void Function(SessionInfoNowPlayingItemBuilder)? updates]) =>
      (new SessionInfoNowPlayingItemBuilder()..update(updates))._build();

  _$SessionInfoNowPlayingItem._(
      {this.name,
      this.originalTitle,
      this.serverId,
      this.id,
  ...
  @override
  SessionInfoNowPlayingItem rebuild(
          void Function(SessionInfoNowPlayingItemBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SessionInfoNowPlayingItemBuilder toBuilder() =>
      new SessionInfoNowPlayingItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SessionInfoNowPlayingItem &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SessionInfoNowPlayingItem')
          ..add('name', name)
...
class SessionInfoNowPlayingItemBuilder
    implements
        Builder<SessionInfoNowPlayingItem, SessionInfoNowPlayingItemBuilder>,
        BaseItemDtoBuilder {
  _$SessionInfoNowPlayingItem? _$v;
  ...
  SessionInfoNowPlayingItemBuilder() {
    SessionInfoNowPlayingItem._defaults(this);
  }

  SessionInfoNowPlayingItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant SessionInfoNowPlayingItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SessionInfoNowPlayingItem;
  }

  @override
  void update(void Function(SessionInfoNowPlayingItemBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SessionInfoNowPlayingItem build() => _build();

  _$SessionInfoNowPlayingItem _build() {
    _$SessionInfoNowPlayingItem _$result;
    try {
      _$result = _$v ??
          new _$SessionInfoNowPlayingItem._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SessionInfoNowPlayingItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
