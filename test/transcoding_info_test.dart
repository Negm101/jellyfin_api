...
void main() {
  ...
  group(TranscodingInfo, () {
    ...
    // bool isVideoDirect
    test('to test the property `isVideoDirect`', () async {
      // TODO
    });

    // bool isAudioDirect
    test('to test the property `isAudioDirect`', () async {
      // TODO
    });
    ...
    test('to test the property `completionPercentage`', () async {
      // TODO
    });
    ...
    // int audioChannels
    test('to test the property `audioChannels`', () async {
      // TODO
    });
